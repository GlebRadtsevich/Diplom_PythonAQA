...
@allure.epic("About Us Page Tests")
@pytest.mark.ui
class TestAboutPage:
    ...
    def test_welcome_section_visible(self, page):
        ...
        # Проверяем наличие раздела Welcome
    ...
    def test_why_us_section_visible(self, page):
        ...
        # Проверяем наличие раздела Why Us
    ...
    def test_click_contact_us_button(self, page):
        ...
        # Нажимаем кнопку Contact Us
        about_page.click_contact_us()

        # Проверяем, что открылось окно контактов (например, изменение URL)
    ...
    def test_click_shop_now_button(self, page):
        ...
        # Нажимаем кнопку Shop Now
        about_page.click_shop_now()

        # Проверяем переход на страницу магазина
