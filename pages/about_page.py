...
class AboutPage(BasePage):
    ...
    WELCOME_SECTION = "#bb-section-60F4A7BE-4C8D-470A-8374-C7E269E614CB > div > div:nth-child(1) > div > div > div:nth-child(3)"
    ...
    def assert_about_us_banner(self):
        """Проверить, что баннер 'About Us' виден на странице."""
    ...
    def assert_welcome_section(self):
        """Проверить, что раздел 'Welcome' виден на странице."""
